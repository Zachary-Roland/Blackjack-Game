...
function playerEval() {
  ...
  if (playerPoints === 21 && compPoints === 21) {
    gameResult = "tie";
    revealCompImg();
    resultsContainer.innerText = `It's a tie! What are the odds?? Refresh to play again!`;
  } else if (playerPoints === 21) {
    gameResult = "win";
    revealCompImg();
    resultsContainer.innerText = `You have 21! You win! Refresh to play again!`;
  } else if (compPoints === 21) {
    gameResult = "lose";
    revealCompImg();
    resultsContainer.innerText = `Dealer has 21! You lose! Refresh to play again!`;
  } else if (playerPoints > 21) {
    gameResult = "lose";
    revealCompImg();
    resultsContainer.innerText = `Busted! Better luck next time! Refresh to play again!`;
  } else {
